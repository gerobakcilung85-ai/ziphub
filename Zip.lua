-- =====================================================
-- ZIP HUB – Violence District (Mobile Edition)
-- Menggunakan Rayfield default, dimodifikasi secara visual
-- =====================================================

-- Load Rayfield (default, tanpa custom asset)
local Rayfield = loadstring(game:HttpGet('https://sirius.menu/rayfield'))()

-- Buat window dengan nama ZIP
...
-- =====================================================
-- MODIFIKASI UI SETELAH LOAD (Ubah Logo & Teks)
-- =====================================================
task.wait(0.5) -- Tunggu UI selesai dibuat

-- Cari semua objek UI Rayfield dan ubah teks "Rayfield" menjadi "ZIP"
local function findAndRename(parent)
    for _, child in ipairs(parent:GetDescendants()) do
        if child:IsA("TextLabel") or child:IsA("TextButton") or child:IsA("TextBox") then
            if child.Text and child.Text:find("Rayfield") then
                child.Text = child.Text:gsub("Rayfield", "ZIP HUB")
            end
        end
        if child:IsA("ImageLabel") and child.Name == "Icon" and child.Parent and child.Parent.Name == "Topbar" then
            -- Ganti logo dengan huruf "Z" (pakai teks, bukan aset)
            local logoText = Instance.new("TextLabel")
            logoText.Parent = child.Parent
            logoText.Size = UDim2.new(0, 30, 0, 30)
            logoText.Position = UDim2.new(0, 8, 0.5, -15)
            ...
            logoText.ZIndex = 10
            child.Visible = false -- sembunyikan logo asli
        end
    end
end

-- Cari di CoreGui (tempat Rayfield biasanya berada)
...
-- Jalankan setelah UI siap
task.spawn(function()
    task.wait(1) -- Tunggu lebih lama agar UI benar-benar muncul
    findRayfieldGUI()
end)

-- =====================================================
-- VARIABEL & FITUR (SAMA SEPERTI SEBELUMNYA)
-- =====================================================
...
-- =====================================================
-- TAB 4: AUTO (Auto Generator, Auto Escape, Smart Gen Teleport)
-- =====================================================
...
-- =====================================================
-- NOTIFICATION AWAL (dengan nama ZIP)
-- =====================================================
Rayfield:Notify({
...
print("✅ ZIP HUB Mobile Edition loaded! (Rayfield default)")
